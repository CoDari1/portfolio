  ...
  return (
      <div className="flex min-h-screen flex-col items-center justify-center px-8 pt-[88px] pb-24">
          ...
          <div className="container mx-auto px-4 py-8 border-border">
              <section className="relative text-center px-8 py-24 lg:py-32 border-b border-border">
                  <div
                      className="pointer-events-none absolute left-1/2 top-[10%] h-[500px] w-[900px] -translate-x-1/2 rounded-full bg-[#7ee787] opacity-20 blur-[60px]"></div>
