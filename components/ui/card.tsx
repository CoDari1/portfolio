...
function ProjectCard({ filename, name, description, tags, href, image }: ProjectCardProps) {
  return (
      <div className="group h-full flex flex-col rounded-lg border border-border bg-card overflow-hidden transition-all hover:-translate-y-1 hover:border-muted-foreground z-10">
